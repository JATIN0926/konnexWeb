...
function App() {
  ...
  return (
    <>
      <div
        className="bg-cover bg-center min-h-screen flex-wrap"
        style={{ backgroundImage: "url(./images/bg.svg)" }}
      >
        <div className="flex flex-col md:flex-row justify-center items-center gap-4 p-4 bg-white bg-opacity-20 backdrop-filter backdrop-blur-xs border border-gray-200 rounded-lg">
